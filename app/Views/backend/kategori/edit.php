            ...
            <form id="formCreate" action="<?= route_to('admin.kategori.update') ?>" class="card" autocomplete="off" method="post" enctype="multipart/form-data">
                ...
                <div class="card-header p-2">
                    <div class="d-flex align-items-center justify-content-between">
                        <span class="ml-2 py-1">Form Edit Kategori</span>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="name" id="name" class="form-control 
                                <?= validation_show_error('name') ? 'is-invalid' : '' ?>" 
                                value="<?= $category->name ?>" placeholder="Masukkan Nama Kategori">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="custom-file">
                                <input type="file" id="cover" name="cover" class="custom-file-input 
                                    <?= validation_show_error('cover') ? 'is-invalid' : '' ?>">
