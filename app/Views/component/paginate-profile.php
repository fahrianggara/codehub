    ...
    <ul class="pagination">
        ...
        <?php if ($pager->hasPrevious()): ?>
            <li class="page-item" data-toggle="tooltip" title="Halaman Pertama">
                <a class="page-link" href="<?= $pager->getFirst() ?>#thread-profile">
        ...
        <li class="page-item <?= !$hasPrevPage ? 'disabled' : '' ?>" data-toggle="tooltip" title="Sebelumnya">
            <a href="<?= $hasPrevPage ? $pager->getPreviousPage() : 'javascript:void(0)' ?>#thread-profile" class="page-link">
        ...
        <li class="page-item <?= !$hasNextPage ? 'disabled' : '' ?>"" data-toggle="tooltip" title="Selanjutnya">
            <a href="<?= $hasNextPage ? $pager->getNextPage() : 'javascript:void(0)' ?>#thread-profile" class="page-link">
        ...
        <?php if ($pager->hasNext()): ?>
            <li class="page-item" data-toggle="tooltip" title="Halaman Terakhir">
                <a class="page-link" href="<?= $pager->getLast() ?>#thread-profile">
