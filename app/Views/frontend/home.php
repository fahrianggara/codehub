...
<section class="homepage" id="homepage">
    <div class="thread container-fluid">  <!-- row container -->
        <div class="row">
            ...
            <div class="col-lg-3 col-md-12 mb-3 order-lg-1 order-3"> <!-- barisn kiri -->
                <div class="sticky">
            ...
            <div class="col-lg-6 col-md-12 mb-3 order-lg-2 order-1"> <!-- baris tengah -->
            ...
            <div class="col-lg-3 col-md-12 mb-3 order-lg-3 order-2"> <!-- baris kanan -->
                <div class="sticky">
                    <div class="thread-header mb-3 list-group-item">
                        Paling disukai
                    </div>
